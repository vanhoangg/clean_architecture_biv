  ...
  Future<File> onConvertImgToJPG(XFile file, {bool isResize = true}) async {
    ...
    if (originalImage != null) {
      ...
      if (isResize) {
        ...
        AppLog.info('originalImage.height: ${originalImage.height} ');
        AppLog.info('originalImage.width: ${originalImage.width} ');
        AppLog.info('ratioScale: $ratioScale ');
      ...
      AppLog.info('File Size: $fileSize bytes');
